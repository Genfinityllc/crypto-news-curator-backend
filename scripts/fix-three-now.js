...
const GENERATIONS = [
  ...
  {
    // Replace dark neon with brighter logo - cyan magenta neon
    oldFile: '03_mirror_floor_reflection_cyan_magenta_split.png',
    newFile: '03_neon_bright_logo.png',
    prompt: `dark environment with neon light accents, dramatic cinematic lighting with cyan neon on the left and magenta neon on the right, photorealistic 3D environment, single prominent cryptocurrency logo symbol as the hero subject rendered in BRIGHT polished chrome metal that is well-lit and clearly visible, the logo has strong highlights and reflections catching the cyan and magenta neon lights, glossy black mirror floor with logo reflection, neon light tubes and lines in the background creating geometric patterns, the logo is the focal point and brightly illuminated not dark, floating glass geometric shapes around catching neon light, cinematic composition, 8k resolution, ultra-detailed, Octane render, Cinema 4D quality, premium 3D CGI product render, no text`
  }
];
