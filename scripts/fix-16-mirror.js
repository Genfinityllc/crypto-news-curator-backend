...
async function main() {
  console.log('🎨 Regenerating #16 ink splash with TRUE mirror chrome logo...\n');

  // Delete any existing versions
  const filesToDelete = [
    '16_ink_splash_mirror_chrome.png',
    '16_ink_splash_bright_purple.png'
  ];
  ...
  fs.writeFileSync(path.join(OUTPUT_DIR, '16_ink_splash_liquid_chrome.png'), Buffer.from(img.data));
  console.log('✅ Saved: 16_ink_splash_liquid_chrome.png');
}
