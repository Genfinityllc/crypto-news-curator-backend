...
const GENERATIONS = [
  ...
  {
    // Like 26 paper explosion - papers flying, lime fire, coins
  ...
  {
    // Like 26 paper explosion - different variation with more coins
...
async function main() {
  console.log('🚀 Fixing All 3 Styles\n');
  console.log('1. Ink splash - brighter purple bg, more 3D logo');
  console.log('2. Paper burst with lime flames - like 26');
  console.log('3. Document explosion with coins - like 26\n');
