...
class StyleCatalogService {
  constructor() {
    ...
    this.styles = {
      ...
      '32_editorial_collage': {
        ...
        prompt: (logoSymbol) => `A bold editorial COLLAGE cover in a gritty torn-paper mixed-media style, like clipped newspaper and document scraps. The collage sheets, backgrounds and textures are FLAT 2D print, not glossy CGI, not glass, no bokeh; the focal element may be a matte minted coin or a physical object with only slight depth, but it is NEVER glowing, neon, holographic, or a glossy 3D render, and the logo NEVER glows. Absolutely NO neon glow, NO holographic sheen, NO circuit-board or wireframe graphics, NO flowing-code or data-stream visuals, NO sci-fi tech look; this is a gritty analog print collage of real photographic cutouts with halftone texture. High-contrast black-and-white photographic cutouts of {{3D_ELEMENTS}} (use ONLY these named subjects, exactly as many as are named, and do NOT add any other buildings or extra subjects), plus a FEW torn documents and abstract paper textures relevant to the news topic in the additional instructions, arranged as ripped-paper fragments with rough torn white edges over a solid background, with generous black negative space and a low number of fragments. Each distinct subject appears AT MOST ONCE, never repeat the same element. If no subjects are named, choose imagery that fits the news topic (this is not always about government buildings). The ${logoSymbol} cryptocurrency logo appears exactly ONCE, stays clearly recognizable with its real shape and mark, and remains a PROMINENT, significant focal element at a substantial size — never tiny, never omitted, never a minor background detail; it is integrated into the hero of the scene (for example minted on the coin, mounted on the machine, or built into the object). Keep it clearly visible and important, and do NOT default to a large dead-center flat logo. Collage textures (halftone, photocopy grain, grunge, ink, spray paint) and connective elements (torn edges, tape, paperclips, staples, seals) are used SELECTIVELY exactly as the COMPOSITION directive specifies, never all at once and never the same combination twice; do NOT treat paperclips or tape as a standard element in every image. TWO-COLOR RULE: use ONLY the two accent colors provided as FLAT color pops (torn color-blocks, painted shapes, halftone fields, spray marks); every other part of the image is BLACK AND WHITE / grayscale, with no other hues. The collage must thematically TELL the specific news story described in the additional instructions. Gritty investigative magazine energy, strong ASYMMETRIC composition, dramatic contrast. Absolutely NO text, NO typography, NO words, NO numbers, NO letters, NO headlines anywhere in the image; all documents, papers, receipts, screens, seals, and stamps must be BLANK or carry only abstract lines, halftone dots, and emblem imagery (eagle, crest, rings), never fake paragraphs, printed body text, invented or misspelled agency names, or gibberish AI writing. Only ONE ${logoSymbol} logo, do not duplicate it. 8k, ultra-detailed, sharp print texture.`
      },
      ...
      '32b_editorial_collage_news': {
        ...
        prompt: (logoSymbol) => `A bold investigative editorial COLLAGE cover in a gritty torn-paper mixed-media style, like clipped newspaper and legal-document scraps pinned to a board. The collage sheets, backgrounds and textures are FLAT 2D print, not glossy CGI, not glass, no bokeh; the focal element or hero cutout may be a matte minted coin or a physical object with only slight depth, but it is NEVER glowing, neon, holographic, or a glossy 3D render, and the logo NEVER glows. Absolutely NO neon glow, NO holographic sheen, NO circuit-board or wireframe graphics, NO flowing-code or data-stream visuals, NO sci-fi tech look; this is a gritty analog print collage of real photographic cutouts with halftone texture. High-contrast black-and-white photographic cutouts of {{3D_ELEMENTS}} (use ONLY these named subjects, exactly as many as are named, do NOT add other buildings or extra subjects), plus a FEW torn documents and abstract paper textures relevant to the news topic in the additional instructions, arranged as ripped-paper fragments with rough torn white edges over a solid background. Keep the number of paper fragments LOW with generous black negative space; do NOT fill the frame with stacks of scraps. Each distinct subject appears AT MOST ONCE, never repeat the same element. The ${logoSymbol} cryptocurrency logo appears exactly ONCE, stays clearly recognizable with its real shape and mark, and remains a PROMINENT, significant focal element at a substantial size — never tiny, never omitted, never a minor background detail; it is integrated into the hero of the scene (for example minted on the coin, mounted on the machine, or built into the object). Keep it clearly visible and important, and do NOT default to a large dead-center flat logo. Collage textures (halftone, photocopy grain, grunge, ink stamps, seals) and connective elements (torn edges, tape, paperclips, staples) are used SELECTIVELY exactly as the COMPOSITION directive specifies, never all at once and never the same combination twice; do NOT treat paperclips or tape as a standard element in every image. TEXT CLIPPINGS: integrate the short factual phrases listed in the additional instructions as REAL, LEGIBLE text, each phrase on its own torn scrap of aged paper, GROUPED TOGETHER in ONE tidy zone (a clean vertical column or a single corner stack), evenly spaced and clearly readable, NOT scattered across the whole frame, in a VARIED MIX of editorial financial-document typography — bold display serif for the key figures, typewriter and rubber-stamped serif for smaller labels, and the occasional bold condensed sans for emphasis, NEVER all one uniform font. Vary the weight, size, and placement across the clippings like a real magazine or SEC filing: set each striking figure LARGE and BOLD with its descriptor in a smaller weight beneath or beside it (a title-and-subtext pairing), and underline or highlight the one or two most important figures with a hand-drawn accent-colour marker stroke. Render them on torn scraps of white, aged-newsprint, or document paper like clipped magazine and stock-certificate fragments. Spell every provided phrase EXACTLY as given with correct characters and digits, no misspellings, no invented words or numbers. CRITICAL: each clipping contains ONLY its exact provided phrase and is otherwise BLANK torn paper — NEVER add body text, article copy, continuation sentences, or extra words under, beside, or around a clipping. Render NO other text anywhere in the image — no fake headlines, no filler ticker tape, no receipts, no code, no random letters or numbers used as texture; the ONLY legible text is the provided phrases. Any seal, stamp, emblem, or crest must EITHER show emblem imagery only (eagle, crest, figures, rings) OR carry the EXACT, correctly spelled real institution name (never an invented, garbled, or misspelled name); prefer real photographic buildings over text-bearing seals. Any printed pages, ledgers, tables, spreadsheets, forms, printouts, receipts, scrolls, or documents in the scene (for example paper coming out of a press or a filing cabinet) must be BLANK or show only a few abstract lines, bars, and marks — never fake tables, numbers, paragraphs, dot-matrix or dotted type, barcodes, or gibberish writing. Never render any hex codes or colour codes as text. TWO-COLOR RULE: use ONLY the two accent colors provided as FLAT color pops (torn color-blocks, painted shapes, halftone fields, and hand-drawn marker underlines or highlights on the one or two most important figures); every other part of the image, including all photographic cutouts, paper, textures, the logo, and all body text, is BLACK AND WHITE / grayscale with no other hues. The collage must thematically TELL the specific news story described in the additional instructions. Gritty investigative magazine energy, strong ASYMMETRIC composition, dramatic contrast. Only ONE ${logoSymbol} logo, do not duplicate it. 8k, ultra-detailed, sharp print texture.`
      },
  ...
  getStylePrompt(styleId, logoSymbol, colorOverrides = null, customSubject = null, logoOverrides = null, patternOverrides = null, palettesBySymbol = null) {
    ...
    if (COLLAGE_STYLE_IDS.has(styleId)) {
      ...
      prompt += ` REAL PHOTOGRAPHIC CUTOUTS: every subject is a gritty black-and-white PHOTOGRAPH cutout, as if scissored from a magazine or newspaper, with heavy halftone dots, photocopy grain and rough torn edges — NOT a clean vector illustration, line drawing, cartoon, or smooth 3D render. This is a ripped-magazine analog collage, not a digital illustration.`;
      if (centeredLogo) {
    ...
    if (colorOverrides) {
      ...
      if (COLLAGE_STYLE_IDS.has(styleId)) {
        ...
        if (c1 && c2) {
          prompt += ` STRICT TWO-COLOR PALETTE for this flat collage: the ONLY chromatic colors in the entire image are ${c1} and ${c2}. These are FLAT PRINTED INKS (torn color-blocks, painted shapes, halftone fields, spray marks, marker underlines), NOT lighting or glow. Use BOTH colors prominently and in roughly equal amounts. Everything else is pure grayscale black and white. Do not introduce any third color. These hex codes are colour instructions for you ONLY — NEVER draw, print, spell, or render the hex codes or any colour codes as visible text, labels, or on any nameplate anywhere in the image.`;
        } else if (c1) {
          prompt += ` STRICT: the ONLY chromatic color in this flat collage is ${c1}, used as a flat printed ink; everything else is grayscale. It is not lighting or glow. This hex code is a colour instruction for you ONLY — NEVER draw or render the hex code or any colour code as visible text anywhere in the image.`;
        }
      }
    }
