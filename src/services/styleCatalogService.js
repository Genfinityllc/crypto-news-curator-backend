  ...
  getStylePrompt(styleId, logoSymbol, colorOverrides = null, customSubject = null, logoOverrides = null, patternOverrides = null, palettesBySymbol = null) {
    ...
    if (customSubject && style.customSubject?.enabled) {
      ...
      if (style.category === 'flat') {
        prompt += `. IMPORTANT: include these subjects as FLAT collage cutouts (not 3D objects): ${subject} — separate from the main logo, each shown at most once at various sizes.`;
      } else {
