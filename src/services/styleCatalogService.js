...
class StyleCatalogService {
  ...
  getStylePrompt(styleId, logoSymbol, colorOverrides = null, customSubject = null, logoOverrides = null) {
    ...
    prompt += ', CRITICAL: the logo must float freely in the scene as a 3D object - absolutely NO rectangular frames, NO bounding boxes, NO square borders, NO card shapes, NO plaques, NO panels, NO glass screens, NO glass cards, NO rounded rectangle containers behind or around the logo - the logo letters and icon are individually rendered in 3D material not placed on or inside any flat surface or container';
