...
const CLIENT_NETWORK_BASE_METADATA = {
  'Hedera': {
    ...
    logoSquare: '/logos/hedera_icon.png',
    color: '#000000',
  ...
  'Algorand': {
    ...
    logoSquare: '/logos/algorand_icon.png',
    color: '#000000',
    secondaryColor: '#ffffff',
  ...
  'Constellation': {
    ...
    logoSquare: '/logos/constellation_icon.png',
    color: '#3C3C3C',
    secondaryColor: '#ffffff',
  ...
  'HashPack': {
    ...
    logoSquare: '/logos/hashpack_icon.png',
    color: '#654CFF',
    secondaryColor: '#ffffff',
